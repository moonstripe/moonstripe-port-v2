    ...
    return (
        <div>
            <div class={tw`w-full mx-auto grid grid-cols-1 md:grid-cols-2 h-2/3 my-0 md:my-auto md:h-full pb-10 bg-white`}>
                ...
                <div class={tw`col-span-1 flex flex-col h-1/2 md:h-full w-3/4 mx-auto md:w-auto md:mr-0 md:ml-4 font-[Inter]`} id="scroll">
                    <div class={tw`h-5/12 my-auto`}>
                        ...
                        <div class={tw`my-auto`}>
                            <h1 class={tw`py-1 text-transparent text-4xl bg-clip-text bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>_Cube</h1>
                            <p class={tw`font-light`}>The Essential Retro Console</p>
                        </div>
                        <div class={tw`my-auto flex flex-row py-4`}>
                            <div class={tw`w-fit border-transparent rounded border-solid border-2 bg-clip-border bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>
                        ...
                        <div class={tw`my-auto py-4 w-full md:w-1/2`}>
                            {
                                section === 0 ? (
                                    <Fragment>
                                        <p class={tw`py-1 text-xl`}><p class={tw`inline text-transparent bg-clip-text bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>Get a _Cube</p> as a stylish gift, or deck out your game lair.</p>
                                    </Fragment>
                            ...
                            }
                            {
                                section === 1 ? (
                                    <Fragment>
                                        <p class={tw`py-1 text-xl`}><p class={tw`inline text-transparent bg-clip-text bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>Customize</p> the LEDs, transparent acrylics, or the front-panel.</p>
                                    </Fragment>
                            ...
                            }
                            {
                                section === 2 ? (
                                    <Fragment>
                                        <p class={tw`py-1 text-xl`}>Built from the ground up to <p class={tw`inline text-transparent bg-clip-text bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>look good in your living room</p>.</p>
                                    </Fragment>
                            ...
                            }
                            {
                                section >= 3 ? (
                                    <Fragment>
                                        <p class={tw`py-1 text-xl`}>Play thousands of games across more than <p class={tw`inline text-transparent bg-clip-text bg-gradient-to-br from-bump-end via-lime-200 to-bump-start`}>20 consoles</p>.</p>
                                    </Fragment>
                                ) : null
                            }
                        </div>
                        <div class={tw`my-auto flex flex-row my-auto`}>
