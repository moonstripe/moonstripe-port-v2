        ...
        <div class={tw`flex flex-col z-10`}>
            <div class={tw`text-white fixed bottom-10 left-10 text-2xl hover:bg-black`} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                ...
                <div class={tw`flex flex-row `}>
                    ...
                    {
                        isHover ? <a href={`mailto:info@moonstripe.com?subject=Let's Build Something Together&body=The sky's the limit!`} target="_blank" rel="noopener noreferrer" class={tw`mx-2 py-2`}>info@moonstripe.com</a> : null
                    }
                </div>
            </div>
        </div>
